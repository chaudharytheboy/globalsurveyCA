    ...
    if($file_name){
        ...
        regular_price = '$reg_price', shipping = '$shipping', quantity = '$qty', review_users = '$review', 
         images = '$target_path1', url_1 = '$url_1', url_2 = '$url_2'  WHERE id = '$id' ");
            ...
            $update = mysqli_query($conn,"update products set product_name = '$pro_name', description = '$desc', product_price= '$price',
                        regular_price = '$reg_price', shipping = '$shipping', quantity = '$qty', review_users = '$review', 
                        img_popular = '$path1', url_1 = '$url_1', url_2 = '$url_2'  WHERE id = '$id' ");
        }
...
//print_r($data);exit;
?>
<div class="col" style='text-align:center;background-color:#d6d6d6;color:#000;padding:2px;margin-top:1rem;letter-spacing:1px;font-family:roboto'>
    ...
    <div class='col-sm-6 col-sm-offset-3'>
      <form method="POST" action="" enctype = 'multipart/form-data' id="submitData">
        ...
        <div class="form-group">
          ...
          <img src="../<?php echo $data['images'];?>" id="blah" width="100px;">
          <input type="file"  name="images"  onchange=readURL(this);>
          <input type='hidden' name="image_id" value="<?php echo $data['id'];?>">
        </div>
        <div class="form-group">
          <label for="exampleInputPassword1" >Most Popular / Top Rated / Best Offer Image Uploaded For</label><br/>
          <img src="../<?php echo $data['img_popular'];?>"  width="100px;" id="globalCA">
          <input type="file"  name="img_popular" onchange = CaTop(this);>
          
        </div>
       
        <button type="submit" class="btn btn-primary" name="update"   style="letter-spacing:2px;width:100%">Submit</button>
      </form>
         </div>
